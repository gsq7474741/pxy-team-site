...
export interface ApiAwardAward extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    award_rank: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    competition_name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    map_embed_code: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiJoinUsPageJoinUsPage extends Struct.SingleTypeSchema {
  collectionName: 'join_us_page';
  info: {
    displayName: 'Join Us Page';
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    enrollment_status: Schema.Attribute.Enumeration<['Current', 'Graduated']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    enrollment_year: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publications: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    research_interests: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    role: Schema.Attribute.Enumeration<
      ['Supervisor', 'Ph.D. Student', 'Master Student', 'Alumni']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPatentPagePatentPage extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Patent Page';
    pluralName: 'patent-pages';
    singularName: 'patent-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPublicationPublication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publication_type: Schema.Attribute.Enumeration<['Journal', 'Conference']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    publication_venue: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    volume_issue_pages: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiRecruitPageRecruitPage extends Struct.SingleTypeSchema {
  collectionName: 'recruit_page';
  info: {
    displayName: 'Recruit Page';
    pluralName: 'recruit-pages';
    singularName: 'recruit-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiResearchAreaResearchArea
  ...
  attributes: {
    ...
    detailed_content: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    order: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    related_awards: Schema.Attribute.Relation<'manyToMany', 'api::award.award'>;
    ...
    related_publications: Schema.Attribute.Relation<
      ...
      'api::publication.publication'
    >;
    research_highlights: Schema.Attribute.Component<'content.highlight', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
